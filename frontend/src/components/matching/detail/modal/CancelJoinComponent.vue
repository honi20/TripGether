...
const pushSubmit = () => { 
    noticeContent.value.title = `${userStore.user.userName}님이 ${matchingStore.matchingDetail.title}에 동행 취소 신청을 보냈습니다.`;
...
<template>
    <v-card-text>
        <div class="mb-4">
            ...
            주최자 <b>{{ matchingStore.matchingDetail.writerName }}</b>님께 동행 취소 신청을 보냅니다.
        </div>

        <div class="mb-2 text-medium-emphasis">취소 신청 메세지</div>
        <v-textarea
            :counter="300"
            class="mb-1"
            rows="10"
